		...
		<div class="um-field">
			...
			<div class="um-col-alt">
				...
				<div <?php if ( $button_style == 'floated' ) { echo 'style="display:inline"'; } ?> class="<?php if ( $button_style == 'responsive' ) echo $class . ' um-half'; ?>">
					<a href="<?php echo $um_social_login->login_url( $provider ); ?>" title="<?php echo $arr['button']; ?>" class="um-button um-alt um-button-social um-button-<?php echo $provider; ?>" data-redirect-url="<?php echo $um_social_login->get_redirect_url(); ?>">
					<?php if ( $show_icons ) { ?>
