...
// SETTINGS
$uppod_settings['uppod.swf']='http://smartbz.pro/wp-content/plugins/uppod.swf';     // <-- Flash http://uppod.ru/player/download/
$uppod_settings['uppod.js']='http://';      // <-- HTML5 http://uppod.ru/help/html5/

$uppod_settings['swfobject.js']='http://ajax.googleapis.com/ajax/libs/swfobject/2.2/swfobject.js';
$uppod_settings['adobe_update']='';
$uppod_settings['wmode']='';
$uppod_settings['bgcolor']='#ffffff';
$uppod_settings['uid']=0;

//VIDEO
$uppod['video']['style']='http://smartbz.pro/wp-content/plugins/video227-308.txt';
$uppod['video']['style_html5']='http://smartbz.pro/wp-content/plugins/video227-308.js';
$uppod['video']['width']='960';
$uppod['video']['height']='540';
