<?php 
	...
	Template Name: Forking licence (bot)
...
<body>
		...
		<br>
	<div class="btn_s">
		<a class="btn__item_s" href="viber://pa?chatURI=turboleader&context=<?=$user_id?>0forkingpr">
		<img src="/wp-content/themes/Richer/long_sushi/img/viber.svg" alt="viber">Viber</a> 
	 
    <a class="btn__item_s" href="https://tx.me/turboleader_bot?start=<?=$user_id?>0forkingpr" >
	<img src="/wp-content/themes/Richer/long_sushi/img/telegram.svg" alt="telegram">Telegram</a>

    <a class="btn__item_s" href="https://m.me/113756900274542/?ref=<?=$user_id?>0forkingpr">
      <img src="/wp-content/themes/Richer/long_sushi/img/messenger.svg" alt="facebook">Facebook</a>   
	  
	  <a class="btn__item_s" href="https://vk.me/public109282240?ref=<?=$user_id?>0forkingpr">
