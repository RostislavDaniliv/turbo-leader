						...
						<div class="wrapper">
							...
							<div class="post-content-container">
								<div class="post-content">
									...
									<?php } else { ?>
									<h3 class="title"><a href="<?php echo esc_url(get_post_meta($post->ID, 'richer_post_url', true)); ?>"  target="_blank" title="<?php printf( esc_attr__('Открыть to %s', 'richer'), the_title_attribute('echo=0') ); ?>" rel="bookmark"><?php the_title(); ?></a></h3>
									<?php } ?>
