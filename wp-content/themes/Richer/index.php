								...
								<div class="clearfix">
									...
									<div class="post-content-container">
										<div class="post-content">
											...
											<h3 class="title"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__('Открыть %s', 'richer'), the_title_attribute('echo=0') ); ?>" rel="bookmark"><?php the_title(); ?></a></h3>
											<?php } else { ?>
											<h3 class="title"><a href="<?php echo esc_url(get_post_meta($post->ID, 'richer_post_url', true)); ?>"  target="_blank" title="<?php printf( esc_attr__('Открыть %s', 'richer'), the_title_attribute('echo=0') ); ?>" rel="bookmark"><?php the_title(); ?></a></h3>
											<?php } ?>
										...
										<div class="wrapper">
											<?php if($options_data['check_readmore'] != "0") { ?>
												<div class="post-more"><a href="<?php the_permalink(); ?>" class="button medium default" title="<?php printf( esc_attr__('Открыть %s', 'richer'), the_title_attribute('echo=0') ); ?>" rel="bookmark"><?php _e('Read more', 'richer'); ?></a></div>
											<?php }?>
						...
						<div class="post blog-item <?php echo $post_class;?>">
							<?php if(get_post_format() != 'quote'  && get_post_format() != 'link') { get_template_part( 'framework/inc/post-format/content', get_post_format() ); } ?>
								...
								<div class="blog-item-description">
									<div class="post-content-container">
										<div class="post-content">
											<h6><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__('Открыть %s', 'richer'), the_title_attribute('echo=0') ); ?>" rel="bookmark"><?php the_title(); ?></a></h6>
											...
											<?php if(get_post_format() != 'quote'){?>
												...
												<a href="<?php the_permalink(); ?>" class="more" title="<?php printf( esc_attr__('Открыть %s', 'richer'), the_title_attribute('echo=0') ); ?>" rel="bookmark"><?php printf( esc_attr__('Read more', 'richer'), the_title_attribute('echo=0') ); ?></a>
													<?php }?>
												</div>
											<?php } else {
												get_template_part( 'framework/inc/post-format/content', get_post_format() );
					...
					<div class="post">
							<div class="wrapper">
								...
								<div class="post-content-container">
									...
									<div class="wrapper">
										<?php if($options_data['check_readmore'] != "0") { ?>
											<div class="post-more"><a href="<?php the_permalink(); ?>" class="button medium default" title="<?php printf( esc_attr__('Открыть %s', 'richer'), the_title_attribute('echo=0') ); ?>" rel="bookmark"><?php printf( esc_attr__('Read more', 'richer'), the_title_attribute('echo=0') ); ?></a></div>
										<?php }?>
										<?php if($options_data['check_meta'] != 0) {?>
											<div class="post-meta"><?php get_template_part( 'framework/inc/meta' ); ?></div>
										<?php } ?>
...
<script src="/wp-content/themes/Richer/js/menu.js"></script> 
<?php get_footer(); ?>
