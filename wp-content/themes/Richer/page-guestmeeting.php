...
$room_url = cw_integrateRoom( 'guest-meeting', $current_user );
		        ...
		        <div class="vc_column-inner ">
		            <div class="wpb_wrapper">
		                <div class="vc_btn3-container vc_btn3-left" style="float: left; margin-right: 20px;">
		                	...
		                	href="https://play.google.com/store/apps/details?id=com.setinbox.game&amp;hl=ru" title="Скачать из PlayMarket" target="_blank">
		                	<i class="vc_btn3-icon fa fa-android"></i> <span>Скачать на Android</span></a>
	                	</div>
	                	<div class="vc_btn3-container vc_btn3-left">
		                	<a class="vc_general vc_btn3 vc_btn3-size-sm vc_btn3-shape-square vc_btn3-style-outline vc_btn3-icon-left vc_btn3-color-white btn-mobile" 
		                	href="https://itunes.apple.com/ru/app/game-united-discount-system/id954809132?mt=8" title="Скачать из PlayMarket" target="_blank">
